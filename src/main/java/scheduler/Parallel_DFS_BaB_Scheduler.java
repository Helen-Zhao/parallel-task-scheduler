...
/**
 * Implementation of depth first branch and bound scheduler using while loops with
 * additions for parallelisation (without visualisation)
 *
 * @author Jacky and Ben - Modified version of the original scheduler produced by Jay
 */
public class Parallel_DFS_BaB_Scheduler implements ParallelSchedulerInterface {
    ...
    public Parallel_DFS_BaB_Scheduler(ValidNodeFinderInterface nodeFinder, ProcessorAllocatorInterface processAllocator) {
