...
public class Nodes_10_SeriesParallelTest {
	...
	public void Nodes_10_SeriesParallel_TwoProc_Test() {
		...
		String[] args = { dir + "/src/test/resources/dotfiles/input/Nodes_10_SeriesParallel.dot", "2", "-p", "4", "-o",
				"Nodes_10_SeriesParallel_TwoProc-output" };
