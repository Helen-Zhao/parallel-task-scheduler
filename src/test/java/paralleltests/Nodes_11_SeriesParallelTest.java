...
public class Nodes_11_SeriesParallelTest {
   ...
   @Test
    public void Nodes_11_SeriesParallel_TwoProc_Test() {
        ...
        String[] args = {dir + "/src/test/resources/dotfiles/input/Nodes_11_SeriesParallel.dot", "2", "-p", "4", "-o",
                "Nodes_11_SeriesParallel_TwoProc-output"};
